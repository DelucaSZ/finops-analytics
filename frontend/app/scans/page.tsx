  ...
  return (
    <>
      ...
      <section className="panel table-panel">
        ...
        <div className="data-table-wrap" role="region" aria-label="Histórico de execuções" tabIndex={0}>
          <table className="data-table"><thead><tr><th scope="col">Conta</th><th scope="col">Gatilho</th><th scope="col">Início</th><th scope="col">Conclusão</th><th scope="col">Achados</th><th scope="col">Status</th></tr></thead>
